...
#define MyAppName "ACE SmartDome Controller X2 Driver"
...
AppId={{918DE818-C199-46DA-8EC0-E10F1D3768E9}
AppName={#MyAppName}
...
OutputBaseFilename=ACEDome_X2_Installer
...
[Files]
Source: "domelist ACEDome.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist ACEDome.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 ACEDome.txt"
; 32 bits
Source: "libACEDome\Win32\Release\libACEDome.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "ACEDome.ui";                               DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "ACE.png";                                  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libACEDome\x64\Release\libACEDome.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "ACEDome.ui";                               DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "ACE.png";                                  DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
